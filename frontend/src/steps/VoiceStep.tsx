...
export const VoiceStep: React.FC<VoiceStepProps> = ({ onComplete }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-2xl mx-auto py-12 px-6 bg-slate-800/50 border border-indigo-500/30 rounded-3xl">
      ...
      <h2 className="text-2xl font-bold text-white mb-4 text-center">Voice Biometrics Enrollment</h2>
      ...
      <p className="text-slate-400 text-center mb-10 max-w-md">
        This step will record a short phrase to generate a 256-d speaker embedding to authenticate you during the AI call.
      </p>
